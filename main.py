...
def clean_text(text):
    BLOCKED_PHRASES = sorted([
        ...
        "איתמר מינמר", "ברק רביד", "דפנה ליאל", "ענבר טויזר", "אלמוג בוקר", "בWhatsApp", "אסף רוזנצוייג", "ביטחון שוטף", "אור רביד", "ניצן שפירא", "דין פישר", "יעל יפה",
    ...
    BANNED_PHRASES = [
        ...
        "בגידה", "רומן", "חברה", "זוגיות", "דוגמנית", "ביקיני", "הלבשה תחתונה", "גופייה", "חשוף", "עירום", "פעוט", "ליגת", "פגיעות", "צניעות", "מעשים מגונים", "תועבה", "ליאור באקאלו", "הגאווה", "האח הגדול", "אנס", "שחקנית", "פועל", "להטבים", "להט\"ב", "להטב״ים", "להטביים",
