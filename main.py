...
def clean_text(text):
    BLOCKED_PHRASES = sorted([
        ...
        "דסק העולם הערבי", "לשיתוף", "לכל העדכונים ~ ראשוני", "סקופים", "דסק החוץ", "מבזקן 12", "אסף רוזנצווייג", "אלי הירשמן", "אלעד שמחיוף",
        "איתמר מינמר", "צפו", "ללא צנזורה חדשות ישראל", "לקבוצת הוואטסאפ לעדכונים חריגים", "ברק רביד", "דפנה ליאל", "ענבר טויזר", "אלמוג בוקר", "בWhatsApp", "אסף רוזנצוייג", "ביטחון שוטף", "אור רביד", "ניצן שפירא", "דין פישר", "יעל יפה",
    ...
    BANNED_PHRASES = [
        ...
        "אולימפיאדה", "מונדיאל", "זמרת", "סדרה", "קולנוע", "תיאטרון", "נטפליקס", "יוטיוב", "פורנוגרפיה", "מיניות", "יחסים", "אונס", "ספוטיפיי", "דוגמנית", "הפלות", "זנות", "חשפנות", "סקס", "אהבה", 
