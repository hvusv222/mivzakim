...
def clean_text(text):
    ...
    STRICT_BANNED = [
        ...
        "אולימפיאדה", "מונדיאל", "זמרת", "סדרה", "קולנוע", "תיאטרון", "נטפליקס", "יוטיוב", "פורנוגרפיה", "מיניות", "קיום יחסים", "אור רביד", "נועם כהן", "אונס", "הכרויות", "וממהרים לבוא", "עד שלא ראיתי", "כוכבת", "ספוטיפיי", "דוגמנית", "טיקטוק", "מערכת יחסים", "הפלות", "זנות", "חשפנות", "סקס", "אהבה", 
    ...
    WORD_BANNED = [
        "גבר", "מין", "רצח את", "הרצח", "תיעוד", "המין", "במין", "עבירות", "בעבירות"
    ]
