...
def clean_text(text):
    ...
    STRICT_BANNED = [
        ...
        "אולימפיאדה", "מונדיאל", "זמרת", "סדרה", "קולנוע", "תיאטרון", "נטפליקס", "יוטיוב", "פורנוגרפיה", "מיניות", "קיום יחסים", "אור רביד", "נועם כהן", "אלימות", "אונס", "הכרויות", "וממהרים לבוא", "עד שלא ראיתי", "כוכבת", "ספוטיפיי", "דוגמנית", "טיקטוק", "הפלות", "זנות", "חשפנות", "סקס", "אהבה", 
