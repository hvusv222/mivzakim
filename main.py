...
def clean_text(text):
    BLOCKED_PHRASES = sorted([
        ...
        "ראש דסק 12", "שושי תחוקה", "לכל העדכונים:", "מה שמעניין", "בוואטסאפ ובטלגרם", "אדר גיציס", "צילום", "יובל שדה", "קרן בצלאל", "ספיר ליפקין", "יולן כהן", "תומר אלמגור",
    ...
    BANNED_PHRASES = [
        ...
        "בגידה", "רומן", "חברה", "זוגיות", "דוגמנית", "ביקיני", "הלבשה תחתונה", "גופייה", "חשוף", "עירום", "פעוט", "ליגת", "פגיעות", "צניעות", "פועל", "להטבים", "להט\"ב", "להטב״ים", "להטביים",
