...
def clean_text(text):
    BLOCKED_PHRASES = sorted([
        ...
        "איתמר מינמר", "צפו>", "כדי להגיב לכתבה לחצו כאן", "ללא צנזורה חדשות ישראל", "#", "גאנם איברהים", "לקבוצת הוואטסאפ לעדכונים חריגים", "https://chat.whatsapp.com/B5sAtMyYFlCJCX0eR99g1M", "ברק רביד", "דפנה ליאל", "ענבר טויזר", "אלמוג בוקר", "בWhatsApp", "אסף רוזנצוייג", "ביטחון שוטף", "טלגרם", "ניצן שפירא", "דין פישר", "יעל יפה",
    ...
    BANNED_PHRASES = [
        ...
        "אולימפיאדה", "מונדיאל", "זמרת", "סדרה", "קולנוע", "תיאטרון", "נטפליקס", "יוטיוב", "פורנוגרפיה", "מיניות", "קיום יחסים", "אור רביד", "נועם כהן", "אלימות", "תיעוד", "אונס", "מין", "הכרויות", "עד שלא ראיתי", "כוכבת", "ספוטיפיי", "דוגמנית", "טיקטוק", "הפלות", "זנות", "חשפנות", "סקס", "אהבה", 
...
while True:
    try:
        ...
        time.sleep(10)  # לחכות 5 שניות ואז להפעיל מחדש את הבוט
