...
def clean_text(text):
    ...
    STRICT_BANNED = [
        ...
        "בגידה", "רומן", "זוגיות", "דוגמנית", "ביקיני", "הלבשה תחתונה", "גופייה", "חשוף", "עירום", "פעוט", "ליגת", "צניעות", "מעשים מגונים", "תועבה", "ליאור באקאלו", "הגאווה", "האח הגדול", "זמר", "גידי גוב", "גרוש", "בת זוג", "בן זוג", "אנס", "שחקנית", "להטבים", "להט\"ב", "להטב״ים", "להטביים",
    ...
    WORD_BANNED = [
        "גבר", "מין", "תיעוד", "המין", "במין", "עבירות", "בעבירות"
    ]
