...
def clean_text(text):
    BLOCKED_PHRASES = sorted([
        ...
        "איתמר מינמר", "צפו>", "כדי להגיב לכתבה לחצו כאן", "חדשות לפני כולם", "ללא צנזורה חדשות ישראל", "#", "גאנם איברהים", "053-419-0216", "לקבוצת הוואטסאפ לעדכונים חריגים", "https://chat.whatsapp.com/B5sAtMyYFlCJCX0eR99g1M", "ברק רביד", "דפנה ליאל", "ענבר טויזר", "אלמוג בוקר", "בWhatsApp", "אסף רוזנצוייג", "ביטחון שוטף", "טלגרם", "ניצן שפירא", "דין פישר", "יעל יפה",
        "ראש דסק 12", "שושי תחוקה", "לכל העדכונים:", "מה שמעניין", "בוואטסאפ ובטלגרם", "אדר גיציס", "צילום", "יובל שדה", "קרן בצלאל", "דביר ג'ברה", "ספיר ליפקין", "ידיעות בני ברק", "להצטרפות", "ישיב’ע זוכע’ר בגוגל צ’אט", "קישור לדיוח אנונימי למערכת", "לכל העדכונים", "נועם כהן", "המַקְרן - רק וידאו", "להצטרפות", "הכי חם ברשת - ’הערינג’", "וואטצפ", "לשליחת חומרים", "053-315-3081", "סקופים מעולם הישיבות הליטאי", "לקריאה נוחה במחשב", "לקריאה נוחה בנייד", "לקריאת נוחה בנייד", "יולן כהן", "תומר אלמגור",
    ...
    STRICT_BANNED = [
        ...
        "אולימפיאדה", "מונדיאל", "זמרת", "סדרה", "קולנוע", "תיאטרון", "נטפליקס", "יוטיוב", "פורנוגרפיה", "מיניות", "קיום יחסים", "אור רביד", "נועם כהן", "אלימות", "אונס", "הכרויות", "וממהרים לבוא", "עד שלא ראיתי", "כוכבת", "ספוטיפיי", "דוגמנית", "טיקטוק", "מערכת יחסים", "הפלות", "זנות", "חשפנות", "סקס", "אהבה", 
        "בגידה", "רומן", "זוגיות", "דוגמנית", "ביקיני", "הלבשה תחתונה", "גופייה", "חשוף", "עירום", "פעוט", "ליגת", "צניעות", "מעשים מגונים", "תועבה", "ליאור באקאלו", "הגאווה", "האח הגדול", "זמר", "גידי גוב", "עמית אטיאס", "גרוש", "בת זוג", "בן זוג", "אנס", "שחקנית", "להטבים", "להט\"ב", "להטב״ים", "להטביים",
        "פסטיבל", "קטינה", "אירוויזיון", "אישה", "אשה בת", "קטינות", "בן גולדפריינד", "בקטינה", "מינית", "מיניות", "מעשה מגונה"
    ]

    # ⭕ מילות בודדות בלבד - חוסמות רק אם הן מילה שלמה
    WORD_BANNED = [
        "גבר", "מין", "רצח", "הרצח", "תיעוד", "המין", "במין", "עבירות", "בעבירות"
    ]
