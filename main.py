...
def clean_text(text):
    ...
    BLOCKED_PHRASES = sorted([
        ...
        "איתמר מינמר", "צפו>", "כדי להגיב לכתבה לחצו כאן", "חדשות לפני כולם", "ללא צנזורה חדשות ישראל", "#", "גאנם איברהים", "053-419-0216", "לקבוצת הוואטסאפ לעדכונים חריגים", "https://chat.whatsapp.com/B5sAtMyYFlCJCX0eR99g1M", "ברק רביד", "דפנה ליאל", "ענבר טויזר", "אלמוג בוקר", "בWhatsApp", "אסף רוזנצוייג", "טלגרם", "ניצן שפירא", "דין פישר", "יעל יפה",
...
def is_shabbat_or_yom_tov():
    try:
        ...
        now = pytz.timezone("Asia/Jerusalem").localize(datetime(2025, 10, 4, 18, 30))  # 🧪 מצב בדיקה
        candle_time = None
        havdala_time = None
        start_time = None
        end_time = None
